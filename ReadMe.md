...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
  ...
  - useRouteMatch is used to add nested URLs dynamically, without having to write the same routes and links over and over again for each separate instance. 

2. How would you explain form validation to someone who has never programmed before?

  - form validation is how we check that the form was completed properly. If it isn't, we notify the user of the error.

3. In 1-2 sentences, define end to end testing.

  - End to end testing is checking that the application runs from one end to the next without error, from start to finish.
